...
public class JugadorJ implements Serializable {
    ...
    public JugadorJ(String nombre, int nivelExperiencia, String estiloJuego, int valorDeVida) {
        this.nombre = nombre;
    ...
    public void combate(JugadorJ contrincante) {
